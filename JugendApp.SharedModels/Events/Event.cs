...
namespace JugendApp.SharedModels.Events
{
    public class Event
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Event"/> class with the specified event details.
        /// </summary>
        ...
        public Event(string title, string description, int personId, int locationId, DateTime startDateTime, DateTime endDateTime)
        {
            Title = title;
